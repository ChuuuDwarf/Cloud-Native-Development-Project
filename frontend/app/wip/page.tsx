...
export default function WipPage() {
  ...
  const experimentOptionsByLab = useMemo(() => {
    ...
    function addOption(labName: string | null | undefined, experimentName: string | null | undefined) {
  ...
  const canCreateWip = selectedSample?.status === 'received' || selectedSample?.status === 'split' || selectedSample?.status === 'pending_transfer'
