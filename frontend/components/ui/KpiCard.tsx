export default function KpiCard({
  ...
  return (
    <div style={{
      ...
      {icon && <div style={{ position: 'absolute', right: 14, top: 14, fontSize: 20, opacity: .2 }}>{icon}</div>}
      <div style={{ fontSize: 10, color: 'var(--text3)', letterSpacing: 2, fontFamily: 'monospace', marginBottom: 10 }}>
        {label}
      </div>
