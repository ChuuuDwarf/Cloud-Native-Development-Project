  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      <select
        ...
        style={{ background: 'var(--s2)', border: '1px solid var(--border)', color: 'var(--text2)', padding: '6px 10px', borderRadius: 7, fontSize: 12, outline: 'none', cursor: 'pointer', fontFamily: 'inherit' }}
      >
